...
public class UsuarioController {
	...
	public ResponseEntity<List<Usuario>> findAllByDescricao(@PathVariable String causa) {
		return ResponseEntity.status(200).body(repository.findAllByCausaContainingIgnoreCase(causa));
	}
